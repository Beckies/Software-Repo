...
<!--                  <li> <a href="#a"><span>Product</span> <i class="fa fa-caret-right"></i> </a>
            ...
            ?>            
            <!-- Menu Item -->
            <li> <a href="#a"> <i class="fa fa-laptop"></i> <span><?php echo $rw['title']; ?></span> <i class="fa fa-angle-right"></i> </a>
      ...
      <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 menu-col-2">
        ...
        <div class="top-searchs hidden-xs"><span class="title">Top
          Searches</span> <span class="links"> <a href="#a">Netbeans</a> | <a href="#a">Visual Studio</a> | <a href="#a">Eclipse</a> | <a href="#a">EMU 8086</a> | <a href="#a">JDK 8</a> | <a href="#a">Andriod Studio</a></span> </div>
        <!-- end: Top Searches -->
