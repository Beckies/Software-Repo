  ...
  <div class="row">
    <div class="col-md-9 col-sm-12 col-xs-12 main-column box-block">
       <!-- This is the beginning of my manin content -->
            <form method="post" action="genpin_process.php?typ=new">
                        <input type="text" value="" name="np" placeholder="Enter the Number of Pins to Generate" class="input4">
                        <button name="submit" type="submit" class="btn small color1">Generate</button>
						</form>
