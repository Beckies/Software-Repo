  ...
  <div class="row">
    <div class="col-md-9 col-sm-12 col-xs-12 main-column box-block">
       <!-- This is the beginning of my manin content -->
		 <form enctype="multipart/form-data" method="post" action="addadmin_process.php?typ=new">
                        <input type="text" value="" name="name" placeholder="Admin Name" class="input4">
                        <input type="phone" value="" name="phone" placeholder="Admin Phone number" class="input4">
                        <input type="email" value="" name="email" placeholder="Admin E-mail" class="input4">
                        <input type="text" value="" name="user" placeholder="Admin Username" class="input4">
