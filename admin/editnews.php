  ...
  <div class="row">
    <div class="col-md-9 col-sm-12 col-xs-12 main-column box-block">
       <!-- This is the beginning of my manin content -->
            <form enctype="multipart/form-data" method="post" action="addnews_process.php?typ=edit">
							  ...
							  <textarea id="text1" name="desc" cols="90" value="" rows="10" placeholder=""><?php echo $row['descp']; ?></textarea>
