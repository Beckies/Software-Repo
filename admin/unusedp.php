...
<div class="container"> 
  ...
  <div class="row">
    ...
    <tbody>
     <?php
     $r = 1;
      $result=mysqli_query($con,"SELECT * FROM pins WHERE status='UNUSED' ORDER BY rec_id desc") or die("Cannot get the FAQS");
      ...
      ?>
        <tr>
            ...
            <td style="color: blue;"><a style="color: blue;" onclick="return confirm('Sure to Delete?')" href="del.php?id=<?php echo $row['rec_id']; ?>&amp;typ=pin">Delete</a></td>
        </tr>
        <?php
        $r++;
