...
$row=$ezzzy->getrow("rec_id",$id,"postcat");
?>
      <!-- end: Quick Help -->
  ...
  <div class="row">
    <div class="col-md-9 col-sm-12 col-xs-12 main-column box-block">
       <!-- This is the beginning of my manin content -->
		 <form enctype="multipart/form-data" method="post" action="ccat_process.php?typ=edit">
                     <input type="hidden" name="rec" value="<?php echo $id; ?>" />
                        ...
                        <button type="submit" class="btn small color1">Edit Category</button>
						</form>
