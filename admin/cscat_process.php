            ...
            <?php
                                ...
                                $target="pic";
								 ...
								 if($tit == "" || $desc ==""){
								   ...
								   //all is now well
                                   /****************************************************************************************/              								   
                                                                     $result = mysqli_query($con, "INSERT INTO scat(catid,title,descp) VALUES('$rec','$tit','$desc')") or die("Cannot perform the insert");
								   if($result){
									 show_success("The Sub Category has been created successfully");
								   }                               
								 ...
								 if($tit == "" || $desc =="")
								  {
								   display_error("All fields are required please");
									 ...
									 //all is now well									
								   $result = mysqli_query($con, "UPDATE scat SET title='$tit',descp='$desc' WHERE rec_id='$rec'") or die(display_error("Cannot update the record to the database"));
								   if($result){									
									 show_success("The Sub Category has been updated successfully");
								   }                                   
