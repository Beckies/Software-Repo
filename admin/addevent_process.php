    ...
    <div class="col-md-9 col-sm-12 col-xs-12 main-column box-block">
       <!-- This is the beginning of my manin content -->
            <?php
               ...
               /*********************************************************************************************/
                $result = mysqli_query($con, "INSERT INTO news(title,descp,dates,times,adates,atimes,ntype,venue,adt,picture)
								   VALUES('$tit','$desc','$dob','$time','$ad','$at','EVENTS','$ven','$adt','$filest')") or die(display_error("Cannot insert the record into the database"));
               if(!$result)
               {
                die("Can't add record - page expire");
               } else{
                show_success("The Event has been created successfully");
               }
               }//end of if(is_uploaded)
               else{
								   $result = mysqli_query($con, "INSERT INTO news(title,descp,dates,times,adates,atimes,ntype,venue,adt)
								   VALUES('$tit','$desc','$dob','$time','$ad','$at','EVENTS','$ven','$adt')") or die(display_error("Cannot insert the record into the database"));
								   if($result){
									 show_success("The Event has been created successfully");
								   }
