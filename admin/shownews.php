     ...
     if($typ == "news"){
      ...
      ?>
        <tr>
            ...
            <td><a style="color: blue;" href="#"><?php echo "http://softwarelibrary/blog-single.php?id=".$row['rec_id']; ?></a></td>
            <td><?php echo $row['descp']; ?></td>
            <td><a style="color: blue;" href="editnews.php?id=<?php echo $row['rec_id']; ?>">Edit</a> || <a style="color: blue;" class="visit" href="news_det.php?typ=news"></a><a style="color: blue;" onclick="return confirm('Sure to Delete?')" href="del.php?id=<?php echo $row['rec_id']; ?>&amp;typ=news">Delete</a></td>
        </tr>
        <?php
        $r++;
