  ...
  <div class="row">
    <div class="col-md-12">
      <div class="page-title">
        <h2>SUB CATEGORY (<?php echo $ezzzy->getval("rec_id",$id,"postcat","title"); ?>) - </h2>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="row">
    <div class="col-md-9 col-sm-12 col-xs-12 main-column box-block">
       <!-- This is the beginning of my manin content -->
		 <form enctype="multipart/form-data" method="post" action="cscat_process.php?typ=new">
                     <input type="hidden" name="rec" value="<?php echo $id; ?>" />
                        <input value="" type="text" name="title" placeholder="Category Title" class="input4">						
                        ...
                        <button type="submit" class="btn small color1">Add Sub Category</button>
						</form>
