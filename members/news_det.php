                ...
                <section class="vbox"> 
                    ...
                    <section class="scrollable wrapper"> 
                        <div class="row"> 
							...
							<aside class="clearfix lter r-r text-right v-middle">
							<div class="wrapper h3 font-thin">
								<img id="lightbox-container-image-boxx"  class="res" src="<?php  echo "../admin/".$rw['picture']; ?>">
							</div>
							</aside>
							<blockquote>
							<p style="text-transform: uppercase;"><?php echo $rw['title']; ?></p>
							<small>From:<cite title="Source Title"><?php echo $ezzzy->getval("rec_id",$rw['schid'],"institutions","iname"); ?></cite> <!-- Dates --></small>
							</blockquote>
							<div>
                             <?php echo $rw['descp']; ?>
                            </div>
					...
					<a class="pull-left thumb-sm avatar"><img src="<?php echo $imgggg; ?>" class="img-circle"></a>
					<section class="media-body">
					<form id="MyUploadForm" method="post" action="getnco.php" class="m-b-none">
					<div class="input-group">
                    <input type="hidden" name="thenews" value="<?php echo $rw['rec_id']; ?>" />
					<input autocomplete="off" type="text" id="FileInput" name="thecore" class="form-control" placeholder="Input your comment here" autocomplete="off">
                                ...
                                /****************************************************************************************************/
							       ...
							       ?>
                                      ...
                                      <div class="panel-body"> <div><?php echo $row1['comment']; ?></div>
                                        <div class="comment-action m-t-sm"><?php if($member_id == $mid ) { ?> <a onclick="return confirm('sure to delete?');" href="./?lnk=del&id=<?php echo $row1['rec_id']; ?>&amp;typ=delnco"  class="btn btn-white btn-xs"><i class="icon-trash text-muted"></i>Remove</a><?php } ?></div>
              						</div>
                                      <?php
