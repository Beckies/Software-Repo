   ...
   /**
    ...
    function showpic($where,$whereval,$typ){
      ...
      //let us get the image of this user
        $myresult = mysqli_query($this->dcon,"SELECT * FROM photos WHERE ".$where."='".$whereval."' and typ='".$typ."'") or die("Cannot get the profile picture");
        if(mysqli_fetch_array($myresult) == 0){
          ...
          while($myrow = mysqli_fetch_array($myresult)){
            $imgg = "../members/upload/uploads/".$myrow['picture'];
          }
